                   ...
                   <div class="row">
                        ...
                        ?>
                          ...
                          <div class="col-md-12">
                            ...
                            <center><div id="piechar"></div></center>

                            <div class="panel panel-default" style="border:2px solid white; color:rgb(111,111,111); font-weight:bold">
                                <header class="panel-heading bg-default" id="piechart">
                                    INSTALLED,DEPLOYED,RETURNED AND DECOMMISSIONED ASSETS

                                </header>
                                <div class="panel-body">

                                <!--<form action="<?php echo site_url('qlip_controller/open_level1_section/1/'.$unames); ?>" method="post" accept-charset="utf-8">
                            ...
                            <form action="<?php echo site_url('qlip_controller/view_report_l1/1/'.$unames); ?>" method="post" accept-charset="utf-8">
                             <?php 
