                   ...
                   <div class="row">
                        ...
                        ?>
                          ...
                          <div class="col-md-12">
                            <div class="panel panel-primary">
                                ...
                                <form action="<?php echo site_url('qlip_controller/open_primera_section/1/'); ?>" method="post" accept-charset="utf-8">
                            ...
                            <form action="<?php echo site_url('qlip_controller/view_report_primera/1'); ?>" method="post" accept-charset="utf-8">
                             <?php 
                                echo include 'include_report_primera.php';
                             ?>
                       ...
                       <?php } else if($director=="ledger_balance"){ ?>
                        ...
                        <!--<div class="col-lg-4">
                                        ...
                                        chat start
                                        <section class="panel panel-primary" style="height:700px">
                                            <header class="panel-heading">
                                                Notifications
                                            </header>
                                                <div class="panel-body" id="noti-box" style="height:700px">

                                                    <div class="alert alert-block alert-danger">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>Pending!</strong> Total transaction(s) posted by all User(s) pending is <?php //echo $pending_count ; ?>
                                                    </div>
                                                    <div class="alert alert-success">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>Approved!</strong> Total transaction(s) posted by all User(s) approved is <?php //echo $approved_count ; ?>
                                                    </div> 
                                                    <div class="alert alert-danger">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>Approved!</strong> Total transaction(s) Authorized approved is <?php //echo $authorized_count ; ?>
                                                    </div>
                                                    <div class="alert alert-warning">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>Declined!</strong> Total transaction(s) posted by all User(s) declined is <?php //echo $declined_count ; ?>
                                                    </div>
                                                    <div class="alert alert-info">
                                                        <button data-dismiss="alert" class="close close-sm" type="button">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        <strong>Applied!</strong> Total Loan Applications posted by all User(s) is <?php //echo ($declined_count+$pending_count+$approved_count) ; ?>
                                                    </div>
