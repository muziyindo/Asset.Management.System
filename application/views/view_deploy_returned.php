                     <?php
                        ...
                        echo form_open_multipart('qlip_controller/insert_deploy_returned/'.$serial_no11.'/'.$deploy_id.'/'.$return_id);
...
<div class="row">
        ...
        <div class="form-group">
		 ...
		 <div class="form-group">
           ...
           <?php
            									//get asset detail
                                                    $sql="select * from returned where rid = '$return_id'";
                                                    $query = $this->db->query($sql);
                                                    foreach ($query->result() as $val_user)
                                                    {
                                                        $tag_no = $val_user->tag_no ;
                                                        //$specification = $val_user->specifications ;
	   ...
	   <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="" name="tag_no" value="<?php echo $tag_no ; ?>" readonly>
            </div>
			<div class="form-group">
