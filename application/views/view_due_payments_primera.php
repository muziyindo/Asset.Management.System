                   ...
                   ?>
                    ...
                    <div class="row">
                        ...
                        <form action="<?php echo site_url('qlip_controller/view_due_payments_primera/1'); ?>" method="post" accept-charset="utf-8">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                               ...
                               <input type="text" class="form-control" id="datepicker2" name="start_date" value="<?php echo $start_date ; ?>" placeholder="Start Date">
                        ...
                        <div class="col-md-3">
                             <div class="form-group">
                               ...
                               <div class="input-group">
                               <input type="text" class="form-control" id="datepicker3" name="end_date" value="<?php echo $end_date ; ?>" placeholder="End Date">
                               <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                               </div>     
                           </div> 
                        </div>
