                   ...
                   ?>
                    ...
                    <div class="row">
                        ...
                        <form action="<?php echo site_url('qlip_controller/search_qlip_uploads_l2'); ?>" method="post" accept-charset="utf-8">
                        <div class="col-md-3">
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped table-bordered" style="font-size:12px;">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-red"><a style="color:white" href="<?php echo site_url(); ?>/qlip_controller/view_uploaded_status/<?php echo $detail['file_id'] ?>/edit"><?php echo $detail['status'] ; ?></a></span></td>
                                            <?php } ?>
                                            <?php
