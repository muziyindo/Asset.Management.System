                   ...
                   ?>
                    ...
                    <div class="row">
                        <!--Search FIlter-->
                        <form action="<?php echo site_url('qlip_controller/search_filter_returned/'); ?>" method="post" accept-charset="utf-8">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default" style="border:2px solid white; color:rgb(111,111,111); font-weight:bold">
                                <header class="panel-heading bg-red">
                                    Returned Asset -- <?php echo count($level1_data); ?> Records Returned
                    ...
                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $detail['date_returned'] ; ?></td>   
