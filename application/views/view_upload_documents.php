                 <?php
                        ...
                        echo form_open_multipart('qlip_controller/insert_loan_images/'.$uname.'/'.$oracle_no);
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <section class="panel panel-default" style="border:2px solid white; color:rgb(111,111,111); font-weight:bold">
                         <header class="panel-heading bg-red">Upload Documents(pdfs)</header>
                         <div class="panel-body">
                           <form enctype="multipart/form-data">
                           
                                           <div class="form-group">
                                               <label for="examplelastname">Unique  ID</label>
                                           ...
                                           <div class="form-group">
                                               <label for="exampleInputemail">Upload Document <span style="background:yellow"></label>
                                           ...
                                           <input type="submit" class="submit btn btn-info" value="Upload->Submit"></input>
                                           <input type="hidden" name="MAX_FILE_SIZE" value="15000000000000"> <!--unit in bytes-->
